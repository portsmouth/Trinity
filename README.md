...
<a href="https://portsmouth.github.io/Trinity/">Trinity</a> is a programmable 3D GPU (WebGL) fluid simulator. The fluid simulation logic is fully customizable via GLSL programs coded directly into the browser (via [CodeMirror](https://codemirror.net)). Click the thumbnails below for a selection of simulation preset running live in the browser.
